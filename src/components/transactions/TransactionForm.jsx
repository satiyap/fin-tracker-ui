...
const TransactionForm = ({ show, handleClose, initialValues, onSubmit, title }) => {
  ...
  return (
    <Modal show={show} onHide={handleClose} size="lg">
      <Modal.Header closeButton>
        <Modal.Title>{title || 'Add Transaction'}</Modal.Title>
      </Modal.Header>
                    ...
                    <Col md={6}>
                      <Form.Group className="mb-3">
                        ...
                        <DatePicker
                          ...
                          className={`form-control ${touched.transactionDate && errors.transactionDate ? 'is-invalid' : ''}`}
